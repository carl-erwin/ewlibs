...
EDITOR_EXPORT
bool editor_event_queue_push(struct editor_event_queue_s * q, struct editor_message_s *ev);

EDITOR_EXPORT
size_t editor_event_queue_wait(struct editor_event_queue_s * q, size_t wait_time);

EDITOR_EXPORT
struct editor_message_s * editor_event_queue_get(struct editor_event_queue_s * q);
